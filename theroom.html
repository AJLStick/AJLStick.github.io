...
<head>
<meta charset="utf-8">
<title>HTML5 Chatroom</title>
<meta name="keywords" content="html5">
<meta name="description" content="A simple html5 Chatroom">
<meta name="author" content="Wang">
<meta name="viewport" content="width=1024">
<style type="text/css">
body{background-color:#fff;color:#444;font-size:14px;line-height:125%;}
...
<div>
	<div id="chat-room">
		<div id="chat-area" id="chat-area"></div>
	...
	<div style="color:#999;padding-top:20px;text-align:center;"><label for="chat-notify" id="chat-notify-label"><input type="checkbox" id="chat-notify">接收桌面通知</label></div>
</div>
...
<script type="text/javascript" src="examples/code-list/ws-chatroom.js"></script>
</body>
</html>
